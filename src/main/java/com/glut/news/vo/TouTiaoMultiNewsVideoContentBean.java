...
public class TouTiaoMultiNewsVideoContentBean implements Serializable {


	   /* public static final Creator<TouTiaoMultiNewsArticleBean> CREATOR = new Creator<MultiNewsArticleDataBean>() {
	        @Override
	        public TouTiaoMultiNewsArticleBean createFromParcel(Parcel in) {
	            return new TouTiaoMultiNewsArticleBean(in);
	        }

	        @Override
	        public TouTiaoMultiNewsArticleBean[] newArray(int size) {
	            return new TouTiaoMultiNewsArticleBean[size];
	        }
	    };*/
	    /**
